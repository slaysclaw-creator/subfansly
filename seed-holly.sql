-- Seed data for Holly creator profile
-- Add to existing creators in fanplace.io database

-- 1. Create user account for Holly
INSERT INTO users (username, email, password_hash, avatar_url, bio, is_creator)
VALUES (
  'holly',
  'holly@fanplace.io',
  'hashed_password_placeholder_holly',
  'https://manageaicreators.com/creators/holly/avatar.jpg',
...
VALUES (
  ...
  'Holly',
  'https://manageaicreators.com/creators/holly/avatar.jpg',
  'https://manageaicreators.com/creators/holly/banner.jpg',
...
-- 3. Create initial posts for Holly (creator_id = 3)
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/morning-routine.jpg',
  FALSE,
  342,
  28,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/fitness-motivation.jpg',
  FALSE,
  598,
  67,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/workout-thumb.jpg',
  'https://manageaicreators.com/creators/holly/posts/full-body-workout.mp4',
  TRUE,
  9.99,
  412,
  89,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/luxury-lifestyle.jpg',
  FALSE,
  723,
  142,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/meal-prep-thumb.jpg',
  'https://manageaicreators.com/creators/holly/posts/meal-prep-guide.mp4',
  TRUE,
  7.99,
  287,
  56,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/bali-teaser.jpg',
  FALSE,
  892,
  203,
  CURRENT_TIMESTAMP
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/daily-vlog-thumb.jpg',
  'https://manageaicreators.com/creators/holly/posts/daily-vlog.mp4',
  TRUE,
  4.99,
  156,
  34,
...
VALUES (
  ...
  'https://manageaicreators.com/creators/holly/posts/wellness-tips.jpg',
  FALSE,
  1045,
  267,
...
-- 4. Add some sample subscribers (John subscribes to Holly)
